...
<div class="form-div">
  ...
  <?php echo $this->_var['lang']['start_date']; ?>:
    <input name="start_date" type="text" id="start_date" size="15" value='<?php echo $this->_var['start_date']; ?>' readonly="readonly" onclick="return showCalendar('start_date', '%Y-%m-%d', false, false, this);">&nbsp;&nbsp;
    <?php echo $this->_var['lang']['end_date']; ?>:
    <input name="end_date" type="text" id="end_date" size="12" value='<?php echo $this->_var['end_date']; ?>' readonly="readonly" onclick="return showCalendar('end_date', '%Y-%m-%d', false, false, this);">
